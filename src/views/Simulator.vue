<template>
    <div >
    <div class="mt-2">
        <h3 class="text-center mb-2 pt-3">
           Fight Simulator
        </h3>
        <div class="row p-3">
            <div class="col-6 border-red-dark card shadow-card shadow-card-l">
                ...
                <div class="col-4 unitname" v-if="unit.key !== 'occupation_troop'" v-for="unit in attacker" :key="unit.key">
                ...
                <div class="col-4 unitname" v-for="training in attackertrainings" :key="training.key"
                    v-if="training.key !== 'routing' && training.key !== 'information'">
            ...
            <div class="col-6 border border-blue-dark card shadow-card shadow-card-l">
                ...
                <div class="col-4 unitname" v-if="unit.key !== 'occupation_troop'" v-for="unit in defender" :key="unit.key">
                    <img class="img-fluid" :src="`/img/units/${unit.key}.png`" >
                    <!-- <div>{{ unit.key }}</div> -->
                    <input v-model="unit.amount" type="number" class="form-control mb-2" /></input>
                </div>
                ...
                <div v-if="defender_type === 'player' && training.key !== 'routing' && training.key !== 'information'"
                    class="col-4 unitname" v-for="training in defendertrainings" :key="training.key">
                    <img class="img-fluid" :src="`/img/trainings/${training.key}.png`"
                        >
                    <!-- <div>{{ training.key }}</div> -->
                    <input v-model="training.lvl" type="number" class="form-control mb-2" /></input>
    ...
    <div class="mb-4 text-center">
        <button @click="handleSubmit" class="btn btn-xxs gradient-highlight mb-2">
            Submit
        </button>
        <button @click="handleReset" class="btn btn-xxs gradient-red mb-2">
            Reset
        </button>
    </div>
    <div v-if="result.result" class="row result">
        <div class="col col-6 p-2 attacker text-center">
            <h5>
                <b>Attacker Start:</b>
        ...
        <div class="col col-6 p-2 defender text-center">
            <h5>
                <b>Defender Start:</b>
        ...
        <div class="col col-6 p-2 attacker text-center">
            <h5>
                ...
                <div v-if="result.attacker.end_value">
                    ...
                    <span>
                        Size:
                        <span class="text-red"> {{ formatNumber(result.attacker.end_value.size -
                    result.attacker.start_value.size) }} </span>
                    </span>
                    <div>
                        Army Lost Value:
                    </div>
        ...
        <div class="col col-6 p-2 defender text-center">
            <h5>
                ...
                <div v-if="result.target.end_value">
                    ...
                    <span>
                        Size:
                        <span class="text-red"> {{ formatNumber(result.target.end_value.size -
                    result.target.start_value.size) }} </span>
                    </span>
                    <div>
                        Army Lost Value:
                    </div>
    ...
    <div class="text-center">
        <button v-if="log && !details" @click="showDetails" class="btn btn-xxs gradient-blue e mb-4 mt-4">
            Show Details
        </button>
    </div>
...
export default {
    ...
    mounted() {
        ...
        if (this.$route.params.values) {
            ...
            this.attacker = attackerUnits.sort((a,b)=> {
